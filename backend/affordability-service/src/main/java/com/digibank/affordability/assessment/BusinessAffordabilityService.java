...
/**
 * Business-loan equivalent of AffordabilityService, in the same assessment context (ARCHITECTURE.md
 * §10). Thresholds are constants for this first pass (matches how the personal AffordabilityRules
 * started life before the admin Rules page existed) — a fast-follow would make these
 * admin-editable the same way, via the rules package's AffordabilityRulesView pattern.
 */
@Service
