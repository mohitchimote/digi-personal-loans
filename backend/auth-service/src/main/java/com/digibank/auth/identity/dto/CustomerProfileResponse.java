package com.digibank.auth.identity.dto;
 ...
 * staffadmin.dto.UserSummaryResponse (admin-only, includes account-management fields like
 * enabled/role) since this is purely for prefilling wizard sections with data the customer
